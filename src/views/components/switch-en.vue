<template>
    <i-article>
        <article>
            ...
            <Alert show-icon style="margin-top: 16px" type="warning">Warning: If you don't use <router-link to="/guide/iview-loader-en">iview-loader</router-link>, you have to use <code>i-switch</code> tag.</Alert>
