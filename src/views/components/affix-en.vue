...
<template>
  <i-article>
    <article>
      ...
      <p>
        By using Affix, user can fix the content at the screen position and it won't scroll with page scrolling. Common
        Usage: Sidebar etc.
      </p>
      ...
      <Demo title="Fixed at the bottom">
        ...
        <div slot="desc">
          ...
          <p>
            Attention，Only one of <code>offset-top</code> and <code>offset-bottom</code> can be set，If you set
            both，<code>offset-top</code> will be used.
          </p>
        </div>
