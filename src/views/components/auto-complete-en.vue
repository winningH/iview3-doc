  ...
  <i-article>
    <article>
      ...
      <Demo title="Customized">
        ...
        <div slot="desc">
          <p>
            You could pass <code>Option</code> as slot of <code>AutoComplete</code>, instead of using data. This allows
            you to customize the display
          </p>
        </div>
      ...
      <Demo title="Lookup-Patterns">
        <div slot="demo">
          <AutoComplete v-model="value4" icon="ios-search" placeholder="input here" style="width:300px">
            <div class="demo-auto-complete-item" v-for="(item, i) in data4" :key="i">
            ...
            <a href="https://www.google.com/search?q=iView" target="_blank" class="demo-auto-complete-more"
              >查看所有结果</a
            >
          </AutoComplete>
        </div>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>size</td>
              <td>
                The size of Input. Optional value: <code>large</code>, <code>small</code>, <code>default</code> or leave
                empty.
              </td>
              <td>String</td>
              <td>-</td>
            ...
            <tr>
              <td>filter-method</td>
              <td>
                Filter options by input, if function, filter options against it. The function will receive two
                arguments, <code>value</code> and <code>option</code>, if the function returns true, the option will be
            ...
            <tr>
              <td>placement</td>
              <td>
                The direction of pop-ups. The value could be <code>bottom</code> or <code>top</code>, supports automatic
                recognition after 2.12.0
              </td>
              <td>String</td>
              <td>bottom</td>
            </tr>
            <tr>
              <td>transfer</td>
              <td>
                Whether to append the layer in body. When used in Tabs or a fixed Table column, suggests adding this
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleSearch2(value) {
        this.data2 =
          !value || value.indexOf('@') >= 0 ? [] : [value + '@qq.com', value + '@sina.com', value + '@163.com']
      },
