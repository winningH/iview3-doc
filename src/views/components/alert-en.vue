  ...
  <i-article>
    <article>
      ...
      <Demo title="Basic Usage">
        ...
        <div slot="desc">
          <p>
            Basic Usage: 4 alternative types: <code>info</code>, <code>success</code>, <code>warning</code>,
            <code>error</code>.
          </p>
        </div>
      ...
      <Demo title="With Description">
        <div slot="demo">
          ...
          <Alert type="error">
            An error prompt
            <span slot="desc"> Custom error description copywriting. <Icon type="help-circled" size="14"></Icon> </span>
          </Alert>
        </div>
        <div slot="desc">
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>type</td>
              <td>
                Alert style, alternative value: <code>info</code>, <code>success</code>, <code>warning</code>,
                <code>error</code>
              </td>
              <td>String</td>
              <td>info</td>
